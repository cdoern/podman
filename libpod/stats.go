...
func (c *Container) GetContainerStats(previousStats *define.ContainerStats) (*define.ContainerStats, error) {
	...
	stats.MemUsage = cgroupStats.MemoryStats.Usage.Usage //Memory.Usage.Usage
...
func calculateBlockIO(stats *runccgroup.Stats) (read uint64, write uint64) {
	for _, blkIOEntry := range stats.BlkioStats.IoServiceBytesRecursive { //Blkio.IoServiceBytesRecursive {
