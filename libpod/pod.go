...
type PodConfig struct {
	...
	InfraContainer *ContainerConfig `json:"infraConfig"`
...
func (p *Pod) ResourceLim() *specs.LinuxResources {
	...
	conf, err := infra.specFromState()
	if err != nil {
		return empty
	}
	if err = JSONDeepCopy(conf.Linux, resCopy); err != nil {
		return nil
	}
	if resCopy != nil && resCopy.Resources != nil && resCopy.Resources.CPU != nil {
		return resCopy.Resources
	}
...
func (p *Pod) CPUPeriod() uint64 {
	resCopy := &specs.Spec{}
	//resCopy.Linux = &specs.Linux{}
	//resCopy.Linux.Resources = &specs.LinuxResources{}
	...
	conf := infra.Config()
	if err := JSONDeepCopy(conf.Spec, resCopy); err != nil {
		return 0
	}
	if resCopy != nil && resCopy.Linux != nil && resCopy.Linux.Resources != nil && resCopy.Linux.Resources.CPU != nil && resCopy.Linux.Resources.CPU.Period != nil {
		return *resCopy.Linux.Resources.CPU.Period
	}
	return 0
}
...
func (p *Pod) CPUQuota() int64 {
	...
	if resCopy != nil && resCopy.Linux != nil && resCopy.Linux.Resources != nil && resCopy.Linux.Resources.CPU != nil && resCopy.Linux.Resources.CPU.Quota != nil {
		return *resCopy.Linux.Resources.CPU.Quota
	}
	return 0
}
...
func (p *Pod) HasInfraContainer() bool {
	...
	//p.config.InfraContainer.IsInfra
}
