...
type PodCreateOptions struct {
	...
	InfraConmonPidFile string            `json:"infra_conmon_pidfile,omitempty"`
...
type ContainerCreateOptions struct {
	...
	CGroupParent      string `json:"cgroup_parent,omitempty"`
	CIDFile           string
	ConmonPIDFile     string `json:"infra_conmon_pidfile,omitempty"`
	CPUPeriod         uint64
	CPUQuota          int64
	CPURTPeriod       uint64
	CPURTRuntime      int64
	...
	Entrypoint        *string `json:"infra_command,omitempty"`
	Env               []string
	EnvHost           bool
	EnvFile           []string
	Expose            []string
	...
	Name              string `json:"infra_name,omitempty"`
	NoHealthCheck     bool
	OOMKillDisable    bool
	OOMScoreAdj       int
	Arch              string
