...
func (ir *ImageEngine) Scp(ctx context.Context, args []string, parentFlags []string, quiet bool) error {
	rep, source, dest, flags, err := domainUtils.ExecuteTransfer(args, parentFlags, quiet)
	if err != nil {
		return err
	}
