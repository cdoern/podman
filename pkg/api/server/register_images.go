...
func (s *APIServer) registerImagesHandlers(r *mux.Router) error {
	...
	*/
	...
	// swagger:operation POST /libpod/images/scp libpod ImageScpLibpod
	// ---
	// tags:
	//  - images
	...
	//   500:
	//     $ref: '#/responses/internalError'
	r.Handle(VersionedPath("/libpod/images/scp"), s.APIHandler(libpod.ImageScp)).Methods(http.MethodPost)
	return nil
}
